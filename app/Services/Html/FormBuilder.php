...
class FormBuilder extends \Collective\Html\FormBuilder {
	...
	public function destroy($text, $message, $class = null)
	{
        ...
        public function labelControl($nom, $label, $attributes = [], $mandatory = FALSE)
	{
                $mandatory = $mandatory ? '<span class="required">* </span>':FALSE;
		return $this->label($nom, $label, $attributes, $mandatory);
	}
        
	public function control($type, $colonnes, $nom, $errors, $label = null, $mandatory = null, $valeur = null, $pop = null, $placeholder = '')
	{
		...
		return sprintf('
			...
			$label ? $this->label($nom, $label, $mandatory,['class' => 'control-label']) : '',

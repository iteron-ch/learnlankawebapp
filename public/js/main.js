...
// auto redirect to login page script on ajax call
  $(function() {

  $( document ).ajaxComplete(function(event, XMLHttpRequest, ajaxOptions)
  {
   // do something with DATA that is returned by the ajax request
   ajax_response=XMLHttpRequest.responseText;
   //console.log('response is::'+ajax_response);
   if(ajax_response=='Unauthorized.'){
    location.reload();

...
;(function ($, window, document, undefined) {
    ...
    var startHandler = function (e, obj) {
        ...
        endHandler = function (e, obj) {
            ...
            $( window ).trigger( "watchdots", sendObj );
    ...
    function DotsJoin(selector, option ) {
        ...
        iObj.object = self;
        DotsJoin.defaults.matrix = [window.questioncontent.ques.option.column, window.questioncontent.ques.option.row];
        DotsJoin.defaults.margin = window.questioncontent.ques.option.margin;
        DotsJoin.defaults.radius = window.questioncontent.ques.option.radius;
        
        option = iObj.option = $.extend({}, DotsJoin.defaults, option);
        readyDom(iObj);
	...
	//var localArray = [36, 65, 80, 95, 110, 126, 127, 114, 100, 86, 71, 56, 40, 39, 53, 68, 83, 98, 114];
        if( window.questioncontent.action === 'student' ){
            var tempPattern = window.questioncontent.userresponse;

...
app.controller( 'measurementCtrl' , function ( $scope, $window, $sce, $rootScope, $routeParams, $modal, Flash, $http ) {
    ...
    $scope.bindIntegerNum = function( index ){
        return $sce.trustAsHtml($scope.questionJSON.questions[index].correctAns);
    };
    ...
    $scope.setCanvasData = function (src, width, height, quesIndex) { 
        ...
        function updateLine1() { 
            ...
            if( $scope.questionJSON.questions[quesIndex].view === 'vertical' ){
               var x = $scope.questionJSON.questions[quesIndex].correctAns;
               var y = 0;                
               ...
               var x = 0;
               var y = $scope.questionJSON.questions[quesIndex].correctAns;                                

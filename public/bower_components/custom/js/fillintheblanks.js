...
/**
 * @ngdoc function
 * @name questionBuilder.controller:fillintheBlanksCtrl
 * @description
 * # fillintheBlanksCtrl
...
app.controller( 'fillintheBlanksCtrl' , function ( $scope, $window, $sce, $rootScope, $routeParams, $modal, Flash, $http ) {
    ...
    $scope.submitFillBlanksCQ = function ( navigateTo, actionMode ) {
    ...
    $scope.previewQuestion = function (preQuesIndex, popupSize) {
        ...
        if ($scope.validatedVal) {
            ...
            var modalInstance = $modal.open({
                templateUrl: 'fillblanksQuestionPre',
                controller: 'questionPreFIBCtrl',
                size: popupSize,
                scope: $scope,
                resolve: {
...
app.controller('questionPreFIBCtrl', function ( $scope, $modalInstance, questionPre, $http, $modal ) {

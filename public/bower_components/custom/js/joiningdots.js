...
app.controller( 'joiningdotsCtrl' , function ( $scope, $window, $sce, $rootScope, $routeParams, $modal, Flash, $http, $timeout ) {
            ...
            questions: [
                {
                    ques: '',
                    imgPath:'',
                    option: {column:14, row:17, radius: 12, margin:6},
                    correctAns: [],
    ...
    $scope.bindClick = function(e){
        ...
        data.append('dimension', [($scope.questionJSON.questions[quesId].option.row * 36 ),($scope.questionJSON.questions[quesId].option.column * 36 )]);

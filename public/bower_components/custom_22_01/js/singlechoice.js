/**
 * Created by sunny.rana on 09-07-2015.
 */
'use strict';

/**
 * @ngdoc function
 * @name questionBuilder.controller:singleChoiceCtrl
 * @description
 * # singleChoiceCtrl
 * Controller of the questionBuilder
 */
var app = angular.module('questionBuilder');
app.controller('singleChoiceCtrl', function ($scope, $window, $sce, $rootScope, $routeParams, $modal, Flash, $http) {
    ...
    $scope.submitSingleCQ = function ( navigateTo, actionMode ) {
    ...
    $scope.previewQuestion = function (preQuesIndex, popupSize) {
        ...
        if ($scope.validatedVal) {
            ...
            var modalInstance = $modal.open({
                templateUrl: 'singleQuestionPre',
                controller: 'questionPreCtrl',
                size: popupSize,
                scope: $scope,
                resolve: {
    ...
    /*Preview Set trigger here*/
    $scope.previewSet = function (popupSize) {
        ...
        if ($scope.submitValidateQues()) {
            ...
            var modalInstance = $modal.open({
                templateUrl: 'singleSetQuestionPre',
                controller: 'questionSetPreCtrl',
                size: popupSize,
                scope: $scope,
                resolve: {
                    questionPre: function () {
...
app.controller('questionPreCtrl', function ( $scope, $modalInstance, questionPre, $http, $modal ) {
...
app.controller('questionSetPreCtrl', function ( $scope, $modalInstance, questionPre, $http, $timeout, $modal ) {

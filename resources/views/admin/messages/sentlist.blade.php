...
<!-- BEGIN PAGE HEADER-->
<!-- BEGIN PAGE HEADER-->
@include('admin.layout._page_header', ['title' => trans('admin/messages.manage_message_centre'), 'trait_1' => trans('admin/messages.sent')])
<!-- END PAGE HEADER-->
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa"></i>{!! trans('admin/messages.sent') !!}
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <table id="sent-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr class="heading">
                            <th>{!! trans('admin/messages.subject') !!}</th>
                            <th>{!! trans('admin/messages.receiver_name') !!}</th>
...
<script>
    var vars = {
        dataTable: "#sent-table",
        listUrl: "{{ route('messages.listrecordsent') }}",

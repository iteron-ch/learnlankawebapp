...
<div class="row">
    <div class="col-md-12">
        <div class="portlet light">
            ...
            <?php // print_r($user); die('jksdhajhsdk'); ?>
            <div class="portlet-body">
                <table class="table table-light table-hover">
                    ...
                    <tr>
                        <td>
                           <strong> {{ trans('admin/tutor.gender') }}</strong>
                        </td>
                        <td>
                            {{ $user->gender }}
                        </td>
                    ...
                    <tr>
                        <td>
                           <strong> {{ trans('admin/tutor.dob_date') }}</strong>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($user->county =='-1')
                                {{ $user->county }}
                            @else
                                {{ trans('admin/admin.other_county') }}
                            @endif
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> 
                            {{ $user->how_you_find ? ($user->how_you_find) : ($user->how_find_other)}}

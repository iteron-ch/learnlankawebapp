<div class="main_panel" ng-controller="measurementCtrl">
    <form name="measurementForm" id="measurementForm" class="margin-bottom-10">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                                ...
                                <div class="col-xs-12 margin-bottom-10 margin-top-10">
                                    <div class="col-xs-10 col-xs-push-2 float-right">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="[%'view'+parentIndex %]" value="horizontal" ng-click="changeView(parentIndex)" ng-model='questionJSON.questions[parentIndex].view'>[%MASTERS.keywords['horizontal']%]
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="[%'view'+parentIndex %]" value="vertical" ng-click="changeView(parentIndex)" ng-model="questionJSON.questions[parentIndex].view">[%MASTERS.keywords['vertical']%]
                                        </label>
                                    </div>
                                </div>                            
                            </div>
                        ...
                        <div class="row base margin-bottom-20">
                            <div class="col-xs-12 margin-bottom-20">
                                <div class="col-xs-10">
                                    <div class="fileinput"  ng-class="questionJSON.id ? 'fileinput-exists' : 'fileinput-new'" data-provides="fileinput" style="width: [%canvasWidth+'px'%]; height: [%canvasHeigth+'px'%];">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: [%canvasWidth+'px'%]; height: [%canvasHeigth+'px'%];" ng-bind-html="imageBind(parentIndex)"></div>
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitMesurementCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitMesurementCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="measurementPre">
    ...
    <div class="modal-body">
        ...
        <div class="row base">
            <div class="col-xs-12">
                <div class="col-xs-10">
                    <canvas id="measurementCanvasPre" height="[%canvasHeigth%]" width="[%canvasWidth%]"></canvas>
                </div>
            </div>
        </div>
    <div>

<div class="main_panel" ng-controller="measurementlineangleCtrl">
    <form name="measurementlineangleForm" id="measurementlineangleForm" class="margin-bottom-10">
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                            ...
                            <div class="row base margin-bottom-20">
                                ...
                                <div class="col-xs-12 margin-bottom-20">
                                    <span style="margin-left:15px;">
                                        <label for="noofoption"><b>Change Protractor: &nbsp;</b></label>
                                        <div class="fileinput"  ng-class="questionJSON.id ? 'fileinput-exists' : 'fileinput-new'" data-provides="fileinput">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="display:none;" ng-bind-html="imageBind(parentIndex, 'protractor')"></div>
                                            <div>
                                                <span class="btn default btn-file">
                                                    ...
                                                    <span class="fileinput-exists" ng-disabled="addQuesBtnState">
                                                        Change </span>
                                                    <input type="file" class="question_image" onchange="angular.element(this).scope().bindClickProtractor(this)" id ="protractor_[%parentIndex%]" name="...">
                                                </span>
                                                <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput" ng-disabled="addQuesBtnState">Remove</a>
                                            </div>
                                        </div>
                                    </span>
                                     <span style="margin-left:20px;">[%questionJSON.questions[parentIndex].option.protractor%]</span>
                                </div>
                                
                                <div class="col-xs-12 margin-bottom-20">
                                    <div class="col-xs-10">
                                        <div class="fileinput" ng-class="questionJSON.id ? 'fileinput-exists' : 'fileinput-new'" data-provides="fileinput">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 300px; height: 200px;" ng-bind-html="imageBind(parentIndex, 'ques')"></div>
                                            <div>
                                                <span class="btn default btn-file">
                                                    <span class="fileinput-new" ng-disabled="addQuesBtnState">
                                                        Select image </span>
                                ...
                                <div class="col-xs-12 margin-bottom-20">
                                    <div class="col-xs-12" style="padding-left:30px;">
                                        <span>
                                            <label for="noofoption" style="margin-left: -15px;"><b>No. of Options:</b></label>
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle === (parentIndex + 1)">
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <div id="setanswer[%parentIndex%]" style="background-image: url('/questionimg/[%questionJSON.questions[parentIndex].option.value%]'); background-size: 100% 100%;background-repeat: no-repeat;width:600px; height:500px;margin-top:20px;">
                                            <canvas id="c[%parentIndex%]" width="600" height="500"></canvas>
                                        </div>
                                    </div>

                                    <div class="col-xs-12 margin-top-10" ng-repeat="eleAnswer in questionJSON.questions[parentIndex].correctAns">
                                        <div class="col-xs-2">
                                            [%eleAnswer.label%]
                                        </div>
                                        <div class="col-xs-2 col-xs-pull-1 margin-bottom-10">
                            ...
                            <div class="row base" style="margin-bottom: 20px;">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitmeasurementlineangleCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitmeasurementlineangleCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="measurementlineanglePre">
    ...
    <div class="row margin-bottom-20">
        <div class="col-xs-12">
            <div style="background-image: url('/questionimg/[%quesArray.questions[quesIndex].option.value%]'); background-size: 100% 100%;background-repeat: no-repeat;width:600px; height:500px;margin-top:20px;">
                <canvas id="canswer[%quesIndex%]" width="600" height="500"></canvas>
            </div>
        </div>
        <div class="col-xs-12 margin-top-10" ng-repeat="eleAnswer in quesArray.questions[quesIndex].correctAns">
            <div class="col-xs-2">[%eleAnswer.label%]</div>
            <div class="col-xs-2 col-xs-pull-1 margin-bottom-10">
                <input type="text" class="btn-input-style text-center" />
            </div>
        </div>
    </div>

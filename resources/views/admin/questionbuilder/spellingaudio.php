<div class="main_panel" ng-controller="spellingaudioCtrl">
    <form name="spellingaudioForm" id="spellingaudioForm" class="margin-bottom-10">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                        ...
                        <div class="row form-header-sub" >
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-7 padding-top-5">
                                    ...
                                    <button type="button" class="btn btn-default btn-sm pull-right view-btn btn-cursor-pointer btn-custom-size" ng-disabled="previewQuesBtnState" tooltip="[%MASTERS.keywords['previewtooltip']%]" ng-click="previewQuestion(parentIndex, 'lg');">[%MASTERS.keywords['preview']%]</button>				
                        ...
                        <div class="row" ng-class="{'margin-bottom-10': showAnswerEle && showAnswerEle == (parentIndex + 1)}">
                            <div class="row base">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-12 margin-bottom-10 questionareawidth">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="fileinput" ng-class="questionJSON.id ? 'fileinput-exists' : 'fileinput-new'" data-provides="fileinput">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 500px; height: 50px;" ng-bind-html="audioBind(parentIndex)"></div>
                                            <div>
                                                <span class="btn default btn-file">
                                                    ...
                                                    <span class="fileinput-exists" ng-disabled="addQuesBtnState">
                                                        Change </span>
                                                    <input type="file" class="question_image" onchange="angular.element(this).scope().bindClick(this)" id ="[%parentIndex%]" data-loader="true" name="...">
                                                </span>
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitSpellingAudioCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitSpellingAudioCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="spellingAudioCQPre">
        ...
        <div class="row">
            ...
            <div class="col-xs-12" ng-hide="false">
                <audio controls autoplay>
                    <source src="[%'/uploads/questionbuilder/'+quesArray.questions[quesIndex].option.value%]" type="audio/ogg">
                    <source src="[%'/uploads/questionbuilder/'+quesArray.questions[quesIndex].option.value%]" type="audio/mpeg">

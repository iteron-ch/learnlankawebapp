<div class="main_panel" ng-controller="selectliteracyCtrl">
    <form name="selectliteracyForm" id="selectliteracyForm" class="margin-bottom-10">
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                            ...
                            <div class="row base margin-bottom-20" ng-repeat="childEle in element.option">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-1 padding-top-10">
                                        <input type="checkbox" ng-disabled="addQuesBtnState" ng-model='questionJSON.questions[parentIndex].option[$index].ischeck'>
                                    </div>
                                    <div class="col-xs-1">
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row base" style="margin-bottom: 20px;">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitselectliteracyCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitselectliteracyCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="selectliteracyPre">
    ...
    <div class="modal-body">
        ...
        <div class="row margin-bottom-20">
            <div class="col-xs-12">
                <span style="float:left;position: relative;margin-right:5px;" ng-repeat="childEleA in quesArray.questions[quesIndex].option"  >
                    <span ng-class="{'spandecoration': childEleA.ischeck}" ng-bind-html="childEleA.option | to_trusted"></span>
                    </br>
                    <div class="arrow1" ng-if="childEleA.ischeck"></div>

<div class="main_panel" ng-controller="reflectionCtrl">
    <form name="reflectionrightdiagonalForm" id="reflectionrightdiagonalForm" class="margin-bottom-10">
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                        ...
                        <div class="row form-header-sub" >
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-7 padding-top-5">
                                    ...
                                    <button type="button" class="btn btn-default btn-sm pull-right reset-btn btn-cursor-pointer btn-custom-size" tooltip="Reset" ng-click="resetDrawing(parentIndex, 'ques');">RESET</button>
                                </div>
                            </div>
                        </div>
                        <div class="row" ng-class="{'margin-bottom-10': showAnswerEle && showAnswerEle == (parentIndex + 1)}">
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <div class="questionpatter" id="patternContainer_ques_[%parentIndex%]"></div>
                                        <div class="questionpatter" style="background-image: url(../../images/rightdiagonal.jpg); height:340px; width:130px;"></div>
                                        <div class="questionpatter" id="patternAnswer_ans_[%parentIndex%]"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <div class="questionpatter" id="setpatternContainer_ques_[%parentIndex%]"></div>
                                        <div class="questionpatter" style="background-image: url(../../images/rightdiagonal.jpg); height:340px; width:130px;"></div>
                                        <div class="questionpatter" id="setpatternAnswer_ans_[%parentIndex%]"></div>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row base" style="margin-bottom: 20px;">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitreflectionrightleftCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitreflectionrightleftCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="reflectionrightleftPre">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="questionpatter" id="prepatternContainer_ques_[%quesIndex%]"></div>
            <div class="questionpatter" style="background-image: url(../../images/rightdiagonal.jpg); height:340px; width:130px;"></div>
            <div class="questionpatter" id="prepatternAnswer_ans_[%quesIndex%]"></div>
        </div>
    </div>    

<div class="main_panel" ng-controller="reflectionCtrl">
    <form name="reflectiontopbottomForm" id="reflectiontopbottomForm" class="margin-bottom-10">
        <div class="row">
            <div class="col-xs-12">
...
<script type="text/ng-template" id="reflectionrightleftPre">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div id="prepatternContainer_ques_[%quesIndex%]"></div>
            <div style="border:2px solid #888888; width:340px; position:absolute; box-shadow:0px 0px 10px #888888;"></div>
            <div id="prepatternAnswer_ans_[%quesIndex%]"></div>
        </div>
    </div>

                            ...
                            <div class="row base">
                                ...
                                <div class="col-xs-12">
                                    <div id="dropanswer[%parentIndex%]" class="col-xs-12 margin-top-15 margin-bottom-20" style="width: 600px; height: 500px;">
                                        ...
                                        <span ng-repeat="optionele in questionJSON.questions[parentIndex].option" ng-style="{'float':'left', 'position':'absolute', 'top':optionele.position.top, 'left':optionele.position.left}">
                                            <div class="droppable" id="label_[%parentIndex%]_[%$index%]" type="text" ng-style="{'float':'left', 'text-align': 'center', 'font-weight':'bold', 'width':optionele.position.width, 'height':optionele.position.height}">[%questionJSON.questions[parentIndex].correctAns[$index].value%]</div>
                                        </span>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div id="droppreanswer" class="col-xs-12 margin-top-15 margin-bottom-20" style="width: 600px; height: 500px;">
                ...
                <span ng-repeat="optionele in quesArray.questions[quesIndex].option" ng-style="{'float':'left', 'position':'absolute', 'top':optionele.position.top, 'left':optionele.position.left}">
                    <div class="droppable" id="label_[%quesIndex%]_[%$index%]" type="text" ng-style="{'display': 'table-cell', 'float': 'none','vertical-align': 'middle', 'text-align':'center', 'font-weight':'bold', 'width':optionele.position.width, 'height':optionele.position.height}"></div>
                </span>
            </div>
        </div>

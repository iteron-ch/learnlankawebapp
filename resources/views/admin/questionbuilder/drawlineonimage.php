<div class="main_panel" ng-controller="drawlineonimageCtrl">
    <form name="drawlineonimageForm" id="drawlineonimageForm" class="margin-bottom-10">
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                        ...
                        <div class="row form-header-sub" >
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-7 padding-top-5">
                                    ...
                                    <button type="button" class="btn btn-default btn-sm pull-right reset-btn btn-cursor-pointer btn-custom-size" ng-disabled="addQuesBtnState" tooltip="Reset" ng-click="resetDrawing(parentIndex, 'ques');">RESET</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12 margin-bottom-20">
                                    <div class="col-xs-10">
                                        <div class="fileinput"  id="fileinput[%parentIndex%]" ng-class="questionJSON.id ? 'fileinput-exists' : 'fileinput-new'" data-provides="fileinput" style="width: 600px; height: 500px;">
                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="display:none; width: 600px; height: 500px;" ng-bind-html="imageBind(parentIndex)"></div>
                                            <div><canvas id="quesCanvasImg[%parentIndex%]" width="600" height="500"></canvas></div>
                                            <div style="top: 0px;position: absolute; border:1px solid #e5e5e5;"><canvas id="quesCanvas[%parentIndex%]" width="600" height="500"></canvas></div>
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row base" style="margin-bottom: 20px;">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitdrawlineonimageCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitdrawlineonimageCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
                                        ...
                                        <button type="button" class="btn btn-default btn-sm pull-right margin-right-15 reset-btn btn-cursor-pointer" tooltip="Reset" ng-click="resetDrawing(parentIndex,'ans');">RESET</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/ng-template" id="drawlineonimagePre">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="col-xs-12 margin-top-15 margin-bottom-20" style="width: 600px; height: 500px;">
                <div><canvas id="preCanvasImg[%quesIndex%]" width="600" height="500"></canvas></div>
                <div style="top: 0px;position: absolute; border:1px solid #e5e5e5;"><canvas id="preCanvas[%quesIndex%]" width="600" height="500"></canvas></div>
            </div>
        </div>
    </div>

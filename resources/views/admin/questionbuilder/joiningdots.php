<div class="main_panel" ng-controller="joiningdotsCtrl">
    <form name="joiningdotsForm" id="joiningdotsForm" class="margin-bottom-10">
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                        ...
                        <div class="row" ng-class="{'margin-bottom-10': showAnswerEle && showAnswerEle == (parentIndex + 1)}">
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    ...
                                    <!--<span style="margin-left:20px;">
                                        <label for="noofoption" style="margin-left: -15px;">Radius:</label>
                                        <input ng-change="updatesetanswer(parentIndex)" type="number" ng-disabled="addQuesBtnState" id="[%'radius'+ parentIndex%]" min='2' ng-model="questionJSON.questions[parentIndex].option.radius" class="btn-input-style text-center"/>
                                    </span>
                                    <span style="margin-left:20px;">
                                        <label for="noofoption" style="margin-left: -15px;">Margin:</label>
                                        <input ng-change="updatesetanswer(parentIndex)" type="number" ng-disabled="addQuesBtnState" id="[%'margin'+ parentIndex%]" min='2' ng-model="questionJSON.questions[parentIndex].option.margin" class="btn-input-style text-center"/>
                                    </span>-->
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <div style="background-image: url(/questionimg/[%questionJSON.questions[parentIndex].imgPath%]);background-repeat: no-repeat; background-size:100% 100%;" id="patternContainer[%parentIndex%]"></div>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row base" style="margin-bottom: 20px;">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitjoiningdotsCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitjoiningdotsCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="joiningdotsPre">

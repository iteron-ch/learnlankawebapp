<div class="main_panel" ng-controller="insertliteracyCtrl">
    <form name="insertliteracyForm" id="insertliteracyForm" class="margin-bottom-10">
                ...
                <div class="col-xs-12" ng-repeat="(parentIndex, element) in questionJSON.questions">
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row" >
                                <div class="col-xs-12">
                                    <div class="col-xs-12 margin-top-15 margin-bottom-20">
                                        <span  class="draggable" style="border: 1px solid #000000; background-color:#edf6ff; padding: 1px 10px 8px 10px; margin:5px; font-weight:bold;" ng-repeat="dragele in dragObjArray">[%dragele%]</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row droppable margin-top-20">
                                <div class="col-xs-12">
                                    <div class="col-xs-11" id="textEditor[%parentIndex%]" >
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitInsertLiteracyCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitInsertLiteracyCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="insertliteracyQuestionPre">
    ...
    <div class="modal-body">
        <div class="row">    
            ...
            <div class="col-xs-12 margin-top-15">
                <div class="col-xs-11" ng-bind-html="tempQuestext | to_trusted" ></div>
            </div>
        </div>
    </div>

<div class="main_panel" ng-controller="multipleChoiceCtrl">	
    <form name="multiplechoiceForm" id="multiplechoiceForm" class="margin-bottom-10">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                            ...
                            <div class="row base margin-bottom-20" ng-repeat="childEle in element.option">
                                <div class="col-xs-12">
                                    <div class="col-xs-10" style="display: flex;">
                                        <!--<div class="padding-top-10" style="display:inline-block; padding-right: 10px;"><input ng-disabled=true type="checkbox" name="multiplechoicecheckbox"></div>-->
                                        <div style="display:inline-block; width: 98%;" >
                                            <textarea ng-hide="true" ng-model="questionJSON.questions[parentIndex].option[$index].option" id="option[%parentIndex + 1%][%$index + 1%]" name="option[%parentIndex + 1%][%$index + 1%]" placeholder="Option write here"></textarea>
                                        </div>
                                    </div>	
                                    <div class="col-xs-1">
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                                    ...
                                    <div class="col-xs-10">
                                        <div style="display: flex;">
                                            <div style="padding-right: 10px; display:inline-block;">
                                                <!--<input type="checkbox" name="multiplechoicecheckbox[%parentIndex%]" ng-model='questionJSON.questions[parentIndex].correctAns[$index].ischeck'>-->
                                                <input type="checkbox" ng-model='questionJSON.questions[parentIndex].correctAns[$index].ischeck' name="multiplechoicecheckbox[%parentIndex%]" id="multiplechoicecheckbox[%parentIndex%][%$index%]" class="custom_multiple ng-hide" />
                                                <label for="multiplechoicecheckbox[%parentIndex%][%$index%]"><span>&nbsp;</span></label>
                                            </div>
                                            <div style="display: inline-block;width: 98%;" ng-bind-html="childEleA.option | to_trusted" ></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row base" style="margin-bottom: 20px;">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitMultipleCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitMultipleCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="multipleQuestionPre">
    ...
    <div class="modal-body">
        ...
        <div class="row margin-bottom-20">
            <div class="col-xs-12" ng-repeat="ele in quesArray.questions[quesIndex].option">
                <div style="display: flex;">
                    <div style="padding-right: 10px; display: inline-block;">
                        <!--<input type="checkbox" style="display: inline-block;" name="multiplechoicecheckbox">-->
                        <input type="checkbox" name="multiplechoicecheckbox[%parentIndex%]" id="multiplechoicecheckbox[%parentIndex%][%$index%]" class="custom_multiple ng-hide" />
                        <label for="multiplechoicecheckbox[%parentIndex%][%$index%]"><span>&nbsp;</span></label>
                    </div>

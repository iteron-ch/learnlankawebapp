<div class="main_panel" ng-controller="simplequesCtrl">
    <form name="simplequesForm" id="simplequesForm" class="margin-bottom-10">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row base" ng-repeat="optionele in questionJSON.questions[parentIndex].correctAns">
                                <div class="col-xs-12">
                                    <div class="col-xs-10">
                                        <input class="pull-left" type="input" name="[%'option' + $index%]" size="50%" ng-model='questionJSON.questions[parentIndex].correctAns[$index].value'/>
                                        <a ng-click="removeElseAnswer(parentIndex, $index)" ng-show="questionJSON.questions[parentIndex].correctAns.length > 1">
                                            <span class="glyphicon glyphicon-remove btn-cursor-pointer remove-option" tooltip="Remove" style="margin-left: 5px;"></span>
                                        </a>
                                        <a ng-click="addElseAnswer(parentIndex, $index)" ng-show="questionJSON.questions[parentIndex].correctAns.length == $index + 1">
                                            <span class="glyphicon glyphicon glyphicon-plus btn-cursor-pointer add-option" tooltip="Add" style="margin-left: 5px;"></span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitsimpleQues( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitsimpleQues(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="simpleQuestionPre">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-xs-4">
                <input type="text" class="form-control margin-bottom-10" style="height: 28px;padding-top:3px;">
            </div>
        </div>
    </div>

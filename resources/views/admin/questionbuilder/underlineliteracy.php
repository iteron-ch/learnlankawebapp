<div class="main_panel" ng-controller="underlineliteracyCtrl">
    <form name="underlineliteracyForm" id="underlineliteracyForm" class="margin-bottom-10">
                    ...
                    <accordion-group is-open="isFirstOpen" class="accordion-margin">
                        ...
                        <div class="row" ng-show="showAnswerEle && showAnswerEle == (parentIndex + 1)">
                            ...
                            <div class="row" >
                                <div class="col-xs-12">
                                    <div class="col-xs-11">
                                        select word or phrase and &nbsp;
                                        <button type="button" ng-click="underlinetext(parentIndex)" class="btn btn-default btn-sm btn-cursor-pointer ok-btn-color">Underline</button>
                                    </div>
                                </div>
                                <div class="col-xs-12" id="textEditor[%parentIndex%]">
                                    <div class="col-xs-11 textEditor"></div>
                                </div>
                            </div>							
                            <hr>
                            <div class="row base">
                                ...
                                <div class="col-xs-12 margin-bottom-10" ng-repeat="correctmarkEle in element.correctmark">
                                    <div class="col-xs-11">
                                        <span><input type="number" style="width: 120px; font-weight:normal;" min='1' ng-model="correctmarkEle.val"/></span>
                            ...
                            <div class="row base">
                                <div class="col-xs-12">
                                    <div class="col-xs-12">
                                        <button type="button" class="btn btn-default btn-sm pull-right ok-btn-color btn-cursor-pointer" ng-click="submitUnderlineLiteracyFormCQ( MASTERS.keywords['submitaction1'], MASTERS.keywords['submitaction4'] )">[%MASTERS.keywords['save']%]</button>
                                        <button ng-hide="questionData.id" type="button" class="btn btn-default btn-sm pull-right margin-right-15 ok-btn-color btn-cursor-pointer" ng-click="submitUnderlineLiteracyFormCQ(MASTERS.keywords['submitaction2'], MASTERS.keywords['submitaction4'])">[%MASTERS.keywords['save&next']%]</button>      
...
<script type="text/ng-template" id="underlineliteracyQuestionPre">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-xs-12">
                Select word or phrase and &nbsp;
                <button type="button" ng-click="underlinetextPre()" class="btn btn-default btn-sm btn-cursor-pointer ok-btn-color">Underline</button>
            </div>
            <div class="col-xs-12 margin-top-15 textEditor" ng-bind-html="quesArray.questions[quesIndex].ques | to_trusted" ></div>
        </div>
    </div>

...
<style>
.bar,
.progress_bar{ float: left; height: 15px; font-size: 11px; text-align: center; border-radius:10px 0  0 10px !important ;}
...
.bar.blue{background: #0229c4;}
.progress_bar span{width: 100%; float:left; margin-top:-15px;}
.bar.full{border-radius: 10px !important; }
.heder_filer{border: 1px solid #ccc; float: left; margin-bottom: 10px; padding: 10px; width: 100%;}

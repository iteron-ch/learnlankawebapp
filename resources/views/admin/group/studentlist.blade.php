...
@section('content')
<!-- BEGIN PAGE HEADER-->
@include('admin.layout._page_header', ['title' => trans('admin/student.manage_student'), 'trait_1' => 'Groups', 'trait_1_link' => route('managegroup.index'), 'trait_2' => trans('admin/student.student')])
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="row">
    <div class="col-md-12">
...
<script>
    ...
    var vars = {
        ...
        listUrl: "/managegroup/grouptudentslistrecord/"+id,

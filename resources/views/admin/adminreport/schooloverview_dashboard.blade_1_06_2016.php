...
<div class="tab-pane fade  @if($testtype == 'dashboard') active in @endif" id="tab_1_3">
    ...
    <ul class="nav nav-tabs">
        <li class="@if($tab == 'eng')active @endif" onclick="getreport(<?php echo $schoolId; ?>, '<?php echo $testtype; ?>', 'eng')">
            <a href="#tab_4_1" data-toggle="tab">
                <span>English</span>
            </a>
        </li>
        <li class="@if($tab == 'math')active @endif" onclick="getreport(<?php echo $schoolId; ?>, '<?php echo $testtype; ?>', 'math')">
    ...
    <div class="tab-content">
        <div style="float:right; padding-right:20px;padding-top:15px">
            <strong>School Average Score: <?php echo $dashboarddetail['schoolAvgScore']?></strong>
            <span>&nbsp;</span>
            <strong>Number of Test Completed: <?php echo $dashboarddetail['testCompleted']?></strong>
        </div>
                ...
                <div>
                    ...
                    <div class="portlet-title blue_heading">
                        <div class="noExl caption">
                            <input type="button" class="btn default" id="exportgraphclass" name="exportgraphclass" value="Export Class Test Graph" onclick="exportClassTestGraph(<?php echo $schoolId; ?>, '<?php echo $testtype; ?>', 'eng')" />
                        </div>
                    </div>
                    ...
                    <div class="portlet-title blue_heading">
                        <div class="noExl caption">
                            <input type="button" class="btn default" id="exportgraph" name="exportgraph" value="Export Class Progress Graph"  onclick="exportClassProgressGraph(<?php echo $schoolId; ?>, '<?php echo $testtype; ?>', 'eng')" />
                        </div>
                    </div>
...
<?php if (!empty($dashboarddetail['classList']) && !empty($dashboarddetail['allClassTestAvg'])) { ?>
    ...
    function exportClassTestGraph(id,report,tab){
        window.location.href = "schooloverview/export/classtestgraph?id=" + id + "&report=" + report + "&tab="+tab;
    }
    <?php }?>
    <?php if (!empty($dashboarddetail['classList']) && !empty($dashboarddetail['allClassStudentAvg'])) { ?>
    ...
    google.charts.setOnLoadCallback(drawBarChart);
        ...
        function exportClassProgressGraph(id,report,tab){
            window.location.href = "schooloverview/export/classprogressgraph?id=" + id + "&report=" + report + "&tab="+tab;
        }
<?php } ?>
</script>
@stop
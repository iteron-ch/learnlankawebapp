            ...
            <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="portlet box red">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <input type="button" class="btn default" name="export" value="Export To Excel" onclick="exportdata('schooltesteng','class_test_eng')"/>
                                                    </div>
                                                </div>
                                                <div class="portlet-body">
                                                    <div class="table-scrollable">
                                                        <table id="schooltesteng" class="table table-striped table-bordered table-hover dataTable no-footer">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                foreach ($dashboarddetail['topicdetail'] as $key => $val) {
                                                                    ?>      
                                                                    <tr class="heading" role="row">
                                                                        <td class="text-center" rowspan="1" colspan="1"><?php echo trim($val->first_name.' '.$val->last_name); ?></td>
                                                                        <?php
                                                                                $avg = 'NA';
                                                                                $tim = 'NA';
                                                                                $avg_total_time = '';
                                                                        ...
                                                                        <td class="text-center" rowspan="1" colspan="1"><?php echo round($atm); ?></td>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="portlet box red">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <input type="button" class="btn default" name="export" value="Export To Excel" onclick="exportdata('schooltestmath','class_test_math')"/>
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                <div class="table-scrollable">
                                                                ...
                                                                foreach ($dashboarddetail['topicdetail'] as $key => $val) {
                                                                    ...
                                                                    <tr class="heading" role="row">
                                                                        ...
                                                                        <?php
                                                                                ...
                                                                                $atm = 'NA';
                                                                                $atm = $val->ks2_maths_baseline_value;
                                                                                if(!empty($dashboarddetail['paper']))
                                                                                {
                                                                                    ...
                                                                                    if($dashboarddetail['paper'] == 2) {
                                                                                        ...
                                                                                        if(!empty($val->attempt_count)) {
                                                                                            $tim = $val->p2_avg_time/60;
                                                                                            $avg_total_time = round(($val->p2_max_time)/60);
                                                                                        }
                                                                                    }
                                                                                    if($dashboarddetail['paper'] == 3) {
                                                                                        ...
                                                                                        if(!empty($val->attempt_count)) {
                                                                                            ...
                                                                                            $avg_total_time = round(($val->p3_max_time)/60);
                                                                                        }
                                                                                    }
                                                                                }
                                                                                else{
                ...
                <div class="tab-pane fade @if($testtype == 'topic')active in @endif" id="tab_1_2">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="@if($testtype == 'topic' && $tab == 'math')active @endif" onclick="getreport(<?php echo $schoolId; ?>, 'topic', 'math')">
                                    ...
                                    <div class="col-md-12">
                                        <div class="dataTables_length select_box_row heder_filer" style="margin:10px;">
                                            <label style="margin-right:20px;">
                                                <select name="sta" id="sta" class="select2me" onchange="getsta(<?php echo $schoolId; ?>, 'topic', 'eng',this.value,<?php if(!empty($substrand)){ echo $substrand; }else{ echo 0; } ?>)">
                                            ...
                                            <a href="/adminreport/classreport?id=<?php echo $schoolId; ?>&report=topic&tab=eng&layout=<?php echo $layout ?>" style="margin-left:15px;"> <input type="button" name="reset" id="reset" value="Reset Filter" class="btn btn-primary grey"></a>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="portlet box red">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                   <input type="button" class="btn default" name="export" value="Export To Excel" onclick="exportdata('schooltopiceng','class_topic_eng')"/>
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                <div class="table-scrollable">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="dataTables_length select_box_row heder_filer" style="margin:10px;">
                                            ...
                                            <a href="/adminreport/classreport?id=<?php echo $schoolId; ?>&report=topic&tab=math&layout=<?php echo $layout ?>" style="margin-left:15px;"> <input type="button" name="reset" id="reset" value="Reset Filter" class="btn btn-primary grey"></a>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="portlet box red">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                   <input type="button" class="btn default" name="export" value="Export To Excel" onclick="exportdata('schooltopicmath','class_topic_math')"/>
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                <div class="table-scrollable">
                                                    <table id="schooltopicmath" class="table table-striped table-bordered table-hover dataTable no-footer">
                                                        <thead>
                                                            <tr class="heading" role="row">
                                                                <th class="text-center" colspan="1">Pupil Name</th>
...
function setdata(id,report,tab){
    ...
    if(paperId ==""){
        window.location.href = "/adminreport/classreport?id=" + id + "&report=" + report + "&tab=" + tab+"&setId="+setId+"&layout="+layout;
    }else{
       window.location.href = "/adminreport/classreport?id=" + id + "&report=" + report + "&tab=" + tab+"&setId="+setId+"&paperId="+paperId+"&layout="+layout; 
    }    
...
function getreport(id, report, tab) {
     var layout = '<?php echo $layout ?>'; 
    window.location.href = "/adminreport/classreport?id="+id+"&report="+report+"&tab="+tab+"&layout="+layout;
}
function getsta(id,report,tab,strand,sustrand){
 var layout = '<?php echo $layout ?>'; 
    if(sustrand !=0){
        window.location.href = "/adminreport/classreport?id="+id+"&report="+report+"&tab="+tab+"&strand="+strand+"&substrand="+sustrand+"&layout="+layout;;
    }else{
        window.location.href = "/adminreport/classreport?id="+id+"&report="+report+"&tab="+tab+"&strand="+strand+"&layout="+layout;;
    }
...
function getsubstr(id,report,tab,sustrand,strand){
 var layout = '<?php echo $layout ?>'; 
    if(strand!=0){
        ...
        window.location.href = "/adminreport/classreport?id="+id+"&report="+report+"&tab="+tab+"&substrand="+sustrand+"&layout="+layout;;
    }

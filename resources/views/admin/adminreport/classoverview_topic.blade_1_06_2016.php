...
<div class="tab-pane fade @if($testtype == 'topic')active in @endif" id="tab_1_2">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="@if($testtype == 'topic' && $tab == 'eng')active @endif" onclick="getreport(<?php echo $schoolId; ?>, <?php echo $classId; ?>, 'topic', 'eng')">
                            <a href="#tab_3_1" data-toggle="tab">
                                <span >English</span>
                            </a></li>
                        <li class="@if($testtype == 'topic' && $tab == 'math')active @endif" onclick="getreport(<?php echo $schoolId; ?>, <?php echo $classId; ?>, 'topic', 'math')">
                                    ...
                                    <div class="col-md-12">
                                        <div class="dataTables_length select_box_row heder_filer" style="margin:10px;">
                                            <label style="margin-right:20px;">
                                                <select name="sta" id="sta" class="select2me" onchange="getsta(<?php echo $schoolId; ?>, <?php echo $classId; ?>,'topic', 'eng',this.value,<?php if(!empty($substrand)){ echo $substrand; }else{ echo 0; } ?>)">
                                            ...
                                            <label><select name="substa" id="substa" class="select2me" onchange="getsubstr(<?php echo $schoolId; ?>, <?php echo $classId; ?>,'topic', '<?php echo $tab; ?>',this.value,<?php if(!empty($strand)){ echo $strand; }else{ echo 0; } ?>)">
                                            ...
                                            <a href="/adminreport/classreport?schoolId=<?php echo $schoolId; ?>&classId=<?php echo $classId; ?>&tab=<?php echo $tab?>&strand=<?php echo $dashboarddetailTopic['strandId'] ?>&substrand=<?php echo $dashboarddetailTopic['substrandId'] ?>&report=topic&layout=<?php echo $layout ?>" style="margin-left:15px;"> <input type="button" name="reset" id="reset" value="Reset Filter" class="btn btn-primary grey"></a>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="table-scrollable">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="dataTables_length select_box_row heder_filer" style="margin:10px;">
                                            <label style="margin-right:20px;">
                                                <select name="sta" id="sta" class="select2me" onchange="getsta(<?php echo $schoolId; ?>, <?php echo $classId; ?>,'topic', 'math',this.value,<?php if(!empty($substrand)){ echo $substrand; }else{ echo 0 ; } ?>)">
                                                    <option value="">Select Strands</option>
                                                    <?php
                                                    if (!empty($dashboarddetailTopic['strands'])) {
                                                        foreach ($dashboarddetailTopic['strands'] as $key => $val) {
                                            ...
                                            <a href="/adminreport/classreport?schoolId=<?php echo $schoolId; ?>&classId=<?php echo $classId; ?>&tab=<?php echo $tab?>&strand=<?php echo $dashboarddetailTopic['strandId'] ?>&substrand=<?php echo $dashboarddetailTopic['substrandId'] ?>&report=topic&tab=math&layout=<?php echo $layout ?>" style="margin-left:15px;"> <input type="button" name="reset" id="reset" value="Reset Filter" class="btn btn-primary grey"></a>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="portlet box red">

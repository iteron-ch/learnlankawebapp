...
<div class="tab-pane fade  @if($testtype == 'test') active in @endif" id="tab_1_1">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="@if($testtype == 'test' && $tab == 'eng')active @endif" onclick="getreport(<?php echo $schoolId; ?>,<?php echo $classId; ?>, 'test', 'eng')">
                                <a href="#tab_2_1" data-toggle="tab">
                                    <span>English</span>
                                </a></li>
                            <li class="@if($testtype == 'test' && $tab == 'math')active @endif" onclick="getreport(<?php echo $schoolId; ?>, <?php echo $classId; ?>,'test', 'math')">
                                ...
                                <div class="table-scrollable">
                                    ...
                                    <div class="heder_filer">
                                        ...
                                        <span style="padding-left:25px">
                                            <input class="btn green" type ="button" name="submit" id="setfilter" value="submit" onclick="setdata(<?php echo $schoolId; ?>, <?php echo $classId; ?>,'test', 'eng')">
                                        </span> 
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="tab-pane  @if($testtype == 'test' && $tab == 'math')active @endif" id="tab_2_2">
                            <div class="table-scrollable">
                                ...
                                <div class="heder_filer">
                                        ...
                                        <span style="padding-left:25px">
                                            <input class="btn green" type ="button" name="submit" id="setfilter" value="submit" onclick="setdata(<?php echo $schoolId; ?>, <?php echo $classId; ?>,'test', 'math')">
                                        </span>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">

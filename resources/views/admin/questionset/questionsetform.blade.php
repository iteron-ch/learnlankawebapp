        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        {!! Form::labelControl('gender',trans('admin/questionset.allow_print'),['class'=>'control-label col-md-3'], TRUE)  !!}
                        <div class="col-md-4">
                            <div class="radio-list" data-error-container="#form_2_membership_error">
                                <label>
                                    {!! Form::radio('is_print', '1') !!}
                                    Yes</label>
                                <label>
                                    {!! Form::radio('is_print', '0', true) !!}
                                    No </label>
                            </div>
                        </div>
                    </div>  
                    @if(isset($questionset['id']) && $questionset['tot_ques_published'] >= 2)
                    <div class="form-group">
                        <label class="control-label col-md-3">{{ trans('admin/questionset.total') }} :</label>
                        <div class="col-md-4">
                            <p class="form-control-static">
                                {{ $questionset['tot_questions'] }}
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">{{ trans('admin/questionset.published') }} :</label>
                        <div class="col-md-4">
                            <p class="form-control-static">
                                {{ $questionset['tot_ques_published'] }}
                            </p>
                        </div>
                    </div>

...
<script>
    ...
    $(document).ready(function() {
        $("#subject").change(function() {
            if($(this).val() != ''){
                $("#key_stage,#difficulty").attr('disabled',false);
            }else{
                $("#key_stage,#difficulty").attr('disabled',true);
            }
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, val) {
                        ...
                        $.each(val, function(childkey, childval) {
                            html += '<option value="' + childkey + '">' + childval + '</option>';
                        });
                        html += '</optgroup>';
                    });

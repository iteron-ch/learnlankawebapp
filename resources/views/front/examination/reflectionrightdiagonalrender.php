    ...
    <div ng-repeat="(parentIndex, quesele) in renderQuestion[currentQues-1].questions">
        <div class="col-md-12 ques_area">
            ...
            <div ng-if="renderQuestion[currentQues - 1].correctAns" class="col-md-12 ques_option">
                ...
                <div class="col-xs-12">
                    <div class="questionpatter" id="correctAnssetpatternContainer_ques_[%parentIndex%]"></div>
                    <div class="questionpatter" style="background-image: url(../../images/rightdiagonal.jpg); height:340px; width:130px;"></div>
                    <div class="questionpatter" id="correctAnssetpatternAnswer_ans_[%parentIndex%]"></div>
                </div>
            </div>
            <!--end -->
        </div>

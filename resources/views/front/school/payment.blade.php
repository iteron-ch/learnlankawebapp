            ...
            <div class="signup_bottom">
                <div class="signup_mid">
                    ...
                    <div class="head signup_2">
                        ...
                        <h1>{{ trans('front/front.pay_with') }}</h1>
                        <div class="paywith_Content ">
                            <ul class="relative">
                                
                                <li class="mtTabs ">
                                   <div class="tabBtn active" id="cc_act"><a href="javascript:void(0);" onClick="payment_by('credit-card')">{{ trans('front/front.card') }}</a>
                                        <span class="arrow"></span>
                                    </div>
                                    <div class="mtTabsCont" id="credit_card_payment">
                                ...
                                <li class="mtTabs">
                                    {!! Form::hidden('payment_type','Invoice',['class'=>'input_text','id'=>'payment_type']  )  !!}
                                    <div class="tabBtn" id="invoice_act"><a href="javascript:void(0);" onClick="payment_by('invoice')">Invoice</a>
                                        <span class="arrow"></span>
                                    </div>
                                     <div class="mtTabsCont" >
                                    <div style="display:none;" id="invoice_div_payment">
                                        <a href="/signupconfirm/Invoiced/{{ $user_id}}/{{ $id}}"><input type="button" name="submit" value="Confirm" class="button next_step2"></a>
                                    </div>
                                    </div>

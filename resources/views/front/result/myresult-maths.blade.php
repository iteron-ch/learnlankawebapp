        ...
        <div class="rmid">
            <div class="result_zone">
                <div class="result_topic_bg">
                    <div class="col1">
                        <a href="{{ route('result.myresultrevision','maths') }}">{!! HTML::image('images/mytopic_icon.png') !!}</a>
                        <span>My Topics</span>
                    </div>
                    <div class="col2">Maths</div>
                    <div class="col3">
                        <a href="{{ route('result.myresulttest','maths') }}">{!! HTML::image('images/myprogress_icon.png') !!}</a>
